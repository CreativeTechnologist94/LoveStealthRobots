...
namespace Weapons
{
    public class Gun : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            Assert.IsNotNull(_gunBarrel, "You have not assigned a gun barrell to gun "+name);
        ...
        {
            IgnoreCollisions(arg0.interactableObject, true);
            _ammoClip = arg0.interactableObject.transform.GetComponent<AmmoClip>();
        }
        
        protected virtual void AmmoDetached(SelectExitEventArgs arg0)
        {
            IgnoreCollisions(arg0.interactableObject, false);
            _ammoClip = null;
        }
        ...
        protected virtual void IgnoreCollisions(IXRSelectInteractable interactable, bool ignore)
        {
